...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC2981Upgradeable.sol@v4.9.2
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155BurnableUpgradeable.sol@v4.9.2
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155SupplyUpgradeable.sol@v4.9.2
...
// File contracts/x3ZeroERC1155.sol
...
// File contracts/x3ZeroERC1155Factory.sol
...
contract x3ZeroERC1155Factory is AccessControl {
    ...
    function createNFT(string calldata _uri) external onlyRole(DEFAULT_ADMIN_ROLE) returns (address){
        address clone = Clones.clone(libraryAddress);
        x3ZeroERC1155(clone).initialize(_uri);
